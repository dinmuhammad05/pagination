...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        function UsersService_1(db) {
            this.db = db;
        }
        UsersService_1.prototype.create = function (userData) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.db.getPool().query(query, [
                                    userData.username,
                                    userData.email,
                                    userData.password,
                                ])];
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, this.db.getPool().query(query, [id])];
                        case 1:
                            result = _a.sent();
        ...
        UsersService_1.prototype.update = function (id, userData) {
            return __awaiter(this, void 0, void 0, function () {
                var fields, values, setClause, query, result;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            fields = Object.keys(userData).filter(function (key) { return userData[key] !== undefined; });
                            values = fields.map(function (field) { return userData[field]; });
                            if (fields.length === 0)
                                return [2 /*return*/, null];
                            setClause = fields.map(function (field, index) { return "".concat(field, " = $").concat(index + 2); }).join(', ');
                            query = "UPDATE users SET ".concat(setClause, " WHERE id = $1 RETURNING *");
                            return [4 /*yield*/, this.db.getPool().query(query, __spreadArray([id], values, true))];
                        case 1:
                            result = _a.sent();
                            return [2 /*return*/, result.rows[0] || null];
                    }
