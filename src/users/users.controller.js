...
var UsersController = function () {
    ...
    var UsersController = _classThis = /** @class */ (function () {
        ...
        UsersController_1.prototype.create = function (userData) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.usersService.create(userData)];
                        case 1: return [2 /*return*/, _a.sent()];
                        case 2:
                            error_1 = _a.sent();
                            throw new common_1.HttpException('Foydalanuvchi yaratishda xatolik', common_1.HttpStatus.BAD_REQUEST);
        ...
        UsersController_1.prototype.findById = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.usersService.findById(parseInt(id))];
                        case 1:
                            user = _a.sent();
                            if (!user) {
        ...
        UsersController_1.prototype.update = function (id, userData) {
            return __awaiter(this, void 0, void 0, function () {
                var user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.usersService.update(parseInt(id), userData)];
                        case 1:
                            user = _a.sent();
                            if (!user) {
                                throw new common_1.HttpException('Foydalanuvchi topilmadi', common_1.HttpStatus.NOT_FOUND);
        ...
        UsersController_1.prototype.delete = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.usersService.delete(parseInt(id))];
                        case 1:
                            deleted = _a.sent();
                            if (!deleted) {
                                throw new common_1.HttpException('Foydalanuvchi topilmadi', common_1.HttpStatus.NOT_FOUND);
                            }
                            return [2 /*return*/, { message: 'Foydalanuvchi o\'chirildi' }];
                    }
                });
            });
        };
